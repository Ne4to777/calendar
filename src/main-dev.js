...
// log(ajs1A.ap(AJS.of(AJS.identity)).equals(ajs1A))
...
// log(ajsPromapA.promap(AJS.identity, AJS.identity).run().first(1) === ajsPromapA.run().first(1))
// log(ajsPromapA.promap(a => f(g(a)), b => h(i(b))).run().first(1) === ajsPromapA.promap(f, i).promap(g, h).run().first(1))
